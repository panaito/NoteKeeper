...
public class NoteReminderReceiver extends BroadcastReceiver {
    ...
    public static final String EXTRA_NOTE_TITLE = "com.jafriam.notekeeper.extras.NOTE_TITLE";
    public static final String EXTRA_NOTE_TEXT = "com.jafriam.notekeeper.extras.NOTE_TEXt";
    public static final String EXTRA_NOTE_ID = "com.jafriam.notekeeper.extras.NOTE_ID";
